...
//            RadioGroup radioGroupGender = (RadioGroup) findViewById(R.id.r_sex);
      ...
      //      long id = helper.insertContact(namestr,agestr,genderstr,weightstr,heightstr,levelstr,unamestr,pass1str,emailstr);
            ...
            if (!pass1str.equals(pass2str)) {
               ...
               Contact c = new Contact();
                ...
                Toast pass = Toast.makeText(SignUp.this, "Complete!!!", Toast.LENGTH_SHORT);
                pass.show();
            }
