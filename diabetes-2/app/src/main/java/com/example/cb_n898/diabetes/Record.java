    ...
    public void onSaveClick(View v) {
        ...
        if (v.getId() == R.id.btn_save) {
            ...
            try{
                ...
                check_insert  =  helper.insertContact(con);
            }catch (Exception e){

            }

            if (check_insert!=-1) {
                Toast pass = Toast.makeText(Record.this, "บันทึกสำเร็จ", Toast.LENGTH_SHORT);
                pass.show();

            } else {
                Toast pass = Toast.makeText(Record.this, "บันทึกไม่สำเร็จ", Toast.LENGTH_SHORT);
                pass.show();
